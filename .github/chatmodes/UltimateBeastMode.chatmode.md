...
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'Sequential Thinking/*', 'Context7/*', '10x-mvp-tracker/*', 'microsoft/playwright-mcp/*', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos', 'runTests']
---
